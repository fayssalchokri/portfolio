    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                <h2>fayssalchokridev.web.app</h2>
                <br />
                <p>
                    fayssalchokridev.web.app is my portfolio website, and also the
                ...
                <ul>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="fayssalchokridev.web.app"
                        >
                            <p>
                                <b>[3D Site]</b> - fayssalchokridev.web.app
                            </p>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/fayssalchokri"
                        >
                            <p>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://chrome.google.com/webstore/detail/fayssalchokri/mfehannpjmgfagldoilpngeoecdfgmnd"
                        >
                            <p>
